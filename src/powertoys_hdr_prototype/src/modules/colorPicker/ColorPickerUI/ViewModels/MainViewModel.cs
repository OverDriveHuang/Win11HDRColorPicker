...
namespace ColorPicker.ViewModels
{
    ...
    public class MainViewModel : ViewModelBase, IMainViewModel
    {
        ...
        private HdrColorSample _hdrColorSample;
            ...
            CancellationToken exitToken)
        {
            ...
            {
                _hdrColorSample = mouseInfoProvider.CurrentHdrColor;
                SetColorDetails(mouseInfoProvider.CurrentColor);
                mouseInfoProvider.MouseColorChanged += Mouse_ColorChanged;
                mouseInfoProvider.MouseHdrColorChanged += Mouse_HdrColorChanged;
        ...
        private void Mouse_HdrColorChanged(object sender, HdrColorSample hdrColor)
        {
            _hdrColorSample = hdrColor;
        ...
        private void SetColorDetails(Color color)
        {
            SetColorDetails(System.Drawing.Color.FromArgb(color.A, color.R, color.G, color.B));
        }

        private string GetColorText(System.Drawing.Color color)
        {
            var format = _userSettings.CopiedColorRepresentationFormat.Value;
            var text = ColorRepresentationHelper.GetStringRepresentation(color, _userSettings.CopiedColorRepresentation.Value, format);
            return HdrFormatHelper.ContainsHdrToken(text) ? HdrFormatHelper.ReplaceHdrTokens(text, _hdrColorSample) : text;
        }
