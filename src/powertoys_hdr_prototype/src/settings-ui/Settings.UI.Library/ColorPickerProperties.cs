...
namespace Microsoft.PowerToys.Settings.UI.Library
{
    public class ColorPickerProperties
    {
        ...
        public ColorPickerProperties()
        {
            ...
            VisibleColorFormats.Add("linear RGB", new KeyValuePair<bool, string>(false, "linear RGB(%Lr, %Lg, %Lb)"));
            VisibleColorFormats.Add("RGB nits", new KeyValuePair<bool, string>(false, "RGB nits(%Nr, %Ng, %Nb)"));
            VisibleColorFormats.Add("Y nits", new KeyValuePair<bool, string>(false, "Y nits(%Ny)"));
            VisibleColorFormats.Add("ICtCp", new KeyValuePair<bool, string>(false, "ICtCp(I=%Ii, I10=%Ic, Ct=%Ct, Cp=%Cp)"));
            ShowColorName = false;
